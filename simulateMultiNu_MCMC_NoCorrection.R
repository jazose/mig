...
paramFile="./PE/PE_Hier83_3Exc";nChains=4;nExcluded=3;CIWidths=c(0.8,0.95);
outFile="./CI/CI_Hier83_3Exc.txt"
...
if(!exists("makeNetRates", mode="function")){source("ageSexPredict_MCMC_NoCorrection.R")}
